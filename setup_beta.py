...
setup(
    ...
    url='https://github.com/BijalBPatel/PolyChemPrint3/tree/beta',  # Optional
    ...
    entry_points={  # Optional
        'console_scripts': [
            'polychemprint3-beta = polychemprint3:main',
        ],
    },
    ...
    project_urls={  # Optional
        ...
        'Source': 'https://github.com/BijalBPatel/PolyChemPrint3/tree/beta',
    },
)
