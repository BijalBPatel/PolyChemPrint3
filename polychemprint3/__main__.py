...
class ioMenu_0Main(ioMenuSpec):
    ...
    def __init__(self, **kwargs):
        ...
        kwargs = {'name': 'Main', 'menuTitle': 'Main Menu', 'menuDesc': 'the root of the PCP3 command-line interface.',
                  'menuItems': {Fore.LIGHTRED_EX + "[q]": Fore.LIGHTRED_EX + "Quit",
                                Fore.LIGHTMAGENTA_EX + "[?]": Fore.LIGHTMAGENTA_EX + "Repeat menu options",
                                Fore.WHITE + "[T] Test Code": Fore.WHITE + "Run test code",
                                Fore.WHITE + "(1) Hardware Control Menu": Fore.WHITE + "Send commands directly to hardware "
                                                                                       "and execute active sequence/recipes",
                                Fore.WHITE + "(0) Configuration/About": Fore.WHITE + "Software setup, options, choose Tool/Axes",
                                Fore.WHITE + "(3) Recipe Menu": Fore.WHITE + "Configure/Activate multi-sequence recipes",
                                Fore.WHITE + "(2) Sequence Menu": Fore.WHITE + "Configure/Activate predefined command "
                                                                               "sequences"}}
        ...
        while not doQuitMenu:
            try:
                ...
                choiceString = io_Prompt("Enter Command:", validate=True,
                                         validResponse=["q", "?", "T", "0", "1", "2", "3", "/", ".", ","]).lower()
                ...
                if choiceString == '?':
                    ...
                    print(Fore.LIGHTRED_EX + "\tInvalid choice, resetting menu..." + Style.RESET_ALL)
...
class ioMenu_1Configuration(ioMenuSpec):
    ...
    def __init__(self, **kwargs):
        ...
        kwargs = {'name': 'ConfigurationMenu', 'menuTitle': 'Configuration/About Menu',
                  'menuItems': {Fore.LIGHTRED_EX + "[q]": Fore.LIGHTRED_EX + "Quit",
                                Fore.LIGHTMAGENTA_EX + "[?]": Fore.LIGHTMAGENTA_EX + "List Commands",
                                Fore.WHITE + "(0) Info and License": Fore.WHITE + "View Program Details and License Text",
                                Fore.WHITE + "(1) Verbose": Fore.WHITE + "Toggles level of output details",
                                Fore.WHITE + "(2) Change Axes": Fore.LIGHTYELLOW_EX + "Current Axes: " + axes.name,
                                Fore.WHITE + "(3) Change Tool 1": Fore.LIGHTYELLOW_EX + "Current Tool 1: " + tool.name,
                                Fore.WHITE + "(4) Change Tool 2": Fore.LIGHTYELLOW_EX + "Current Tool 2: " + tool2.name,
                                Fore.WHITE + "(5) Change Tool 3": Fore.LIGHTYELLOW_EX + "Current Tool 3: " +
                                                                  tool3.name}}
        super().__init__(**kwargs)
    ...
    def io_Operate(self):
        ...
        while not doQuitMenu:
            try:
                self.__init__()
                self.ioMenu_printMenu(showStoredCmds=False)
                choiceString = io_Prompt("Enter Command:", validate=True,
                                         validResponse=["q", "?", "0", "1", "2", "3", "4", "5", "6"]).lower()
                ...
                if choiceString == '?':
                    ...
                    for axesCode in sorted(__axesDict__):  # Prompt User
                        ...
                        print("\t\t(%-3s) %-10s" % (axesCode, axesName))

                    subChoice = io_Prompt("Enter device to make active", validate=True,
                                          validResponse=[*__axesDict__, 'q'], caseSensitive=False)
                    # Make uppercase
                    ...
                    if not subChoice == 'Q':
                        try:
                            ...
                            if deactiv == 1 and activ == 1:
                                print("\t\tAxes Changed and Activated "
                                      "Successfully!")
                    ...
                    subChoice = io_Prompt("Enter device to make active, q to quit", validate=True,
                                          validResponse=[*__toolDict__, 'q'], caseSensitive=False)
                    # make uppercase
                    subChoice = subChoice.upper()
                    if not subChoice == 'Q':
                        ...
                        try:
                            ...
                            logging.exception(inst)
                            tool = oldtool
                elif choiceString == '4':  # Change Tool 2
                    print("\t\tCurrently Loaded Tool Options: ")
                    for toolCode in sorted(__toolDict__):
                        toolobj = __toolDict__.get(toolCode)
                        toolName = toolobj.name
                    ...
                    if not subChoice == 'Q':
                        ...
                        try:
                            ...
                            logging.exception(inst)
                            tool2 = oldtool
                elif choiceString == '5':  # Change Tool 3
                    print("\t\tCurrently Loaded Tool Options: ")
...
class ioMenu_1Hardware(ioMenuSpec):
    ...
    def __init__(self, **kwargs):
        ...
        kwargs = {'name': 'HardwareMenu', 'menuTitle': 'Hardware Control Menu',
                  ...
                  'menuInstruc': Fore.WHITE + "Choose an execution option "
                                              ...
                                              "command for the axes. " + Fore.RED + '\n\tBe careful! There is '
                                                                                    'limited error-checking!' + Style.RESET_ALL,
                  'menuItems': {Fore.LIGHTRED_EX + "[q]": Fore.LIGHTRED_EX + "Quit",
                                Fore.LIGHTMAGENTA_EX + "[?]": Fore.LIGHTMAGENTA_EX + "List Commands",
                                Fore.WHITE + "[#SP, #SV, #SE, #SM]": Fore.WHITE + "Prime, View, Execute, or Modify "
                                                                                  "Active Sequence",
                                Fore.YELLOW + "a,d; r,f; s,w": Fore.YELLOW + "Coarse Jog -,+ 1mm in X; Y; Z",
                                Fore.YELLOW + "x,z; c,v": Fore.YELLOW + "Fine Jog in Z [-0.1, -0.01; +0.1, "
                                                                        "+ 0.01] mm",
                                Fore.WHITE + "(1) Clean Routine": Fore.WHITE + "Lift up 20 mm, lower on cmd",
                                Fore.WHITE + "(2) Lift Tool": Fore.WHITE + "Lift up 20 mm",
                                Fore.WHITE + "(3) Bring Bed Forward/Back": Fore.WHITE + "Bring bed forward Y+50 mm, return on "
                                                                                        "cmd",
                                Fore.GREEN + "T# on": Fore.GREEN + "Engage Tool Dispense [ex: T3 on]",
                                Fore.GREEN + "T# off": Fore.GREEN + "Disengage Tool Dispense [ex: T1 off]",
                                Fore.GREEN + "T# [Value]": Fore.GREEN + "Sets the tool value [ex: T2 30.5]",
                                Fore.WHITE + "[#MS, #MR]": Fore.WHITE + "Quick Switch to Sequence or Recipe "
                                                                        "Menus"}}
        super().__init__(**kwargs)
    ...
    def io_Operate(self):
        ...
        while not doQuitMenu:
            try:
                ...
                choiceString = io_Prompt("Enter Command:", validate=False, validResponse=[]).lower()
                ...
                # If user wants to use a convenient routine
                    ...
                    # Prompt to Lower
                    choiceString = io_Prompt("\tLower 20 mm?(Y/N):", validate=True, validResponse=["Y", "N"]).lower()
                    if choiceString == 'y':
                    ...
                    # Prompt to return
                    choiceString = io_Prompt("\tReturn Y-50 mm? (Y/N):", validate=True,
                ...
                print("\n\tKeyboardInterrupt received, resetting menu, and attempting to disengage tools")
                tool.disengage()
                tool2.disengage()
                tool3.disengage()
    ...
    def ioMenu_printMenu(self):
        ...
        # Also print active axes and tools
        print(Fore.LIGHTYELLOW_EX)
        print("\t%-35s|  %-25s" % ("Active Sequence:", seqName))
        print("\t%-35s|  %-25s" % ("Active Axes:", axes.name))
        print("\t%-35s|  %-25s" % ("Active Tool 1:", tool.name))
        print("\t%-35s|  %-25s" % ("Active Tool 2:", tool2.name))
        print("\t%-35s|  %-25s" % ("Active Tool 3:", tool3.name))
...
class ioMenu_1PrintFile(ioMenuSpec):
    ...
    def __init__(self, **kwargs):
        ...
        kwargs = {'name': 'PrintFileMenu', 'menuTitle': 'Print File Menu',
                  'menuItems': {Fore.LIGHTRED_EX + "[q]": Fore.LIGHTRED_EX + "Quit",
                                Fore.LIGHTMAGENTA_EX + "[?]": Fore.LIGHTMAGENTA_EX + "List Commands",
                                "STOP": "Emergency STOP", "a,d;r,f;w,s;x,z": "Jog (X; Y; Z; Zsmall)",
                                "(0) SetZero": "Perform Origin set sequence", "(1) PickFile": "Pick a GCODE file",
                                "(2) PrintFile": "Execute print sequence", "(3) FileText": "Display GCODE file"}}
...
class ioMenu_2PrintFileOptions(ioMenuSpec):
    ...
    def __init__(self, **kwargs):
        ...
        kwargs = {'name': 'PrintFileOptionsMenu', 'menuTitle': 'Print File Options Menu',
                  'menuItems': {Fore.LIGHTRED_EX + "[q]": Fore.LIGHTRED_EX + "Quit",
                                Fore.LIGHTMAGENTA_EX + "[?]": Fore.LIGHTMAGENTA_EX + "List Commands",
                                "L": "Advanced Log Options", "(9) Execute": "Start print sequence",
                                "(6) GenCmds": "Generate command arrays", "(8) DispCode": "Display printing code",
                                "(7) DispCmds": "Display current commands", "(0) Clean": "raise/lower 20mm",
                                "(1) Hardware": "Go to hardware menu", "(2) Plot": "Select Plotter Mode (No Extruder))",
...
class ioMenu_1PrintSequence(ioMenuSpec):
    ...
    def __init__(self, **kwargs):
        ...
        kwargs = {'name': 'PrintSequenceMenu', 'menuTitle': 'Print Sequence Menu',
                  'menuItems': {Fore.LIGHTRED_EX + "[q]": Fore.LIGHTRED_EX + "Quit",
                                Fore.LIGHTMAGENTA_EX + "[?]": Fore.LIGHTMAGENTA_EX + "List Commands",
    ...
    def ioMenu_printMenu(self):
        ...
        print('\tSequences are pre-programmed, parameterized print routines '
        ...
        storedCmds = {Fore.LIGHTCYAN_EX + "[/] Repeat Last Command": self.lastCmd,
                      Fore.LIGHTCYAN_EX + "[.] Repeat Saved Command": self.memCmd,
                      Fore.LIGHTCYAN_EX + "[,] Store Saved Command": "Will Prompt for command"}
    ...
    def io_Operate(self):
        ...
        while not doQuitMenu:
            try:
                ...
                choiceString = io_Prompt("Enter Command:", validate=True,
                                         validResponse=(["q", "?", "h", "/", ".", ","] + stringList)).lower()
...
class ioMenu_1PrintRecipe(ioMenuSpec):
    ...
    def __init__(self, **kwargs):
        ...
        kwargs = {'name': 'PrintRecipeMenu', 'menuTitle': 'Recipe Menu',
                  'menuItems': {Fore.LIGHTRED_EX + "[q]": Fore.LIGHTRED_EX + "Quit",
                                Fore.LIGHTMAGENTA_EX + "[?]": Fore.LIGHTMAGENTA_EX + "List Commands",
                                Fore.WHITE + "(1) Browse/Load Stored Recipes": Fore.WHITE + "Search through recipe folder for "
                                                                                            "recipe to activate",
                                Fore.WHITE + "(2) Add to/Modify/Save Active Recipe": Fore.WHITE + "Remove/Reorder sequences, change "
                                                                                                  "parameters, and save to yaml file",
                                Fore.WHITE + "(3) Create a New Recipe": Fore.WHITE + "Start a new recipe from scratch",
                                # Fore.WHITE + "(3) Reuse a stored recipe":
                                #    Fore.WHITE + "Import sequences from a stored
                                #    recipe to the active recipe",
                                Fore.LIGHTYELLOW_EX + "[PRIME]": Fore.LIGHTYELLOW_EX + "Build active recipe into "
                                                                                       "python code",
                                Fore.LIGHTYELLOW_EX + "[VIEW]": Fore.LIGHTYELLOW_EX + "View active recipe details",
                                Fore.LIGHTGREEN_EX + "[GO]": Fore.LIGHTGREEN_EX + "Begin recipe execution"}}
        super().__init__(**kwargs)
    ...
    def ioMenu_printMenu(self):
        ...
        print(Fore.YELLOW + "\tActive Recipe: " + str(__activeRecipe__.name) + "| " + str(
            __activeRecipe__.description) + "| " + str(__activeRecipe__.dateCreated))
    ...
    def io_Operate(self):
        ...
        while not doQuitMenu:
            try:
                ...
                choiceString = io_Prompt("Enter Command:", validate=True, validResponse=(
                    ["q", "?", "1", "2", "3", "/", ".", ",", "go", "view", "prime"]), caseSensitive=False)
                ...
                if choiceString == '?':
                    ...
                    print("\t| Code | %25s | %25s | %50s |" % (
                        str.center("Name", 25), str.center("Date Created", 25), str.center("Description", 50)))
                    stubNum = 0
                    validOptions = ["q"]
                    for stub in __recipeStubList__:
                        ...
                        print("\t| %-4s | %-25s | %-25s | %-50s |" % (
                            "(" + str(stubNum) + ")", stub.name, stub.dateCreated, stub.description))
                    ...
                    try:
                        ...
                        print("\t\tError: Could not create new recipe, "
...
class ioMenu_2SequenceOptions(ioMenuSpec):
    ...
    def __init__(self, seq: sequenceSpec, **kwargs):
        ...
        kwargs = {'name': self.seq.dictParams.get("name").value,
                  'menuTitle': "Sequence: " + self.seq.dictParams.get("name").value + ": " + self.seq.dictParams.get(
                      "description").value, 'menuItems': menuItems}
        super().__init__(**kwargs)
    ...
    def ioMenu_printMenu(self):
        ...
        for pNum in self.paramsMenuDict:
            ...
            paramStrings.append("\t(%-3s) %-25s| %-45s| %-10s| %-50s" % (
                str(pNum), str(param.name)[:23], str(param.value)[:43], str(param.unit)[:10], str(param.helpString)))
        ...
        while not doQuitMenu:
            try:
                ...
                if choiceString == 'q':
                    ...
                    print("\tModifying parameter %s: %s" % (paramNum, param.name))
                    ...
                    oldVal = param.value
                    param.value = newVal
                    print("\tValue changed from %s to %s" % (oldVal, param.value))
                else:
                    print("\tReceived: " + choiceString)
                    print(Fore.LIGHTRED_EX + "\tInvalid Choice, resetting menu" + Style.RESET_ALL)
            except KeyboardInterrupt:
...
class ioMenu_2RecipeOptions(ioMenuSpec):
    ...
    def __init__(self, **kwargs):
        ...
        menuItems = {Fore.LIGHTRED_EX + "[q]": Fore.LIGHTRED_EX + "Quit",
                     ...
                     Fore.WHITE + "(2) Edit Sequence": Fore.WHITE + "Edit an existing sequence",
        ...
        kwargs = {'name': "RecipeEditMenu", 'menuTitle': "Add to/Modify/Save Active Recipe: ", 'menuItems': menuItems}
        super().__init__(**kwargs)
            ...
            try:
                ...
                if choiceString == 'q':
                    ...
                    seqRem = io_Prompt("Enter index of sequence to remove ("
                                       "S#), q to cancel: ", validate=True, validResponse=validSeqIndex)
                    if seqRem == 'q':
                        pass
                    else:
                        try:
                    ...
                    while not doneReord:
                        indexOld = io_Prompt("Enter index of sequence to "
                                             "move (S#), q to finish: ", validate=True, validResponse=validSeqIndex)
                        if indexOld == 'q':
                            doneReord = True
                        else:
                            try:
                                indexNew = io_Prompt("Enter index you would like "
                                                     "the sequence to occupy (S#), "
                                                     "q to cancel: ", validate=True, validResponse=validSeqIndex)
                                if indexNew == 'q':
                                    pass
                                else:
...
def io_StartText():
    ...
    print("=" * 150)
    print("\tPolyChemPrint3 - Version:" + str(__version__) + "\tRevised: " + __date__)
    print("=" * 150)
...
def io_Prompt(promptString: str, validate=False, validResponse=None, caseSensitive=False):
    ...
    if validate:
        ...
        if not validString:
            ...
            inString = io_Prompt(promptString, validate, validResponse, caseSensitive)
        else:
            if not (inString in ["/"]):
...
def io_savedCmdOps(inString):
    """Handles processing saved/ repeat commands for the interface.
...
def io_MenuManager(initialMenuString):
    ...
    while not menuFlag == 'quit':
        ...
        if menuFlag == 'M0MainMenu':
            ...
            (M2PrintFileOptions.ioMenu_updateStoredCmds(__lastInp__, __savedInp__))
            ...
            print(
                Fore.LIGHTRED_EX + "\tInternal CLI Error:" + "Invalid flag returned from menu, resetting to main menu." + Style.RESET_ALL)
            menuFlag = 'M0MainMenu'
    return menuFlag
...
def io_loadPCP(objType):
    ...
    if objType == 'sequence':
        ...
        print(textCol + "Loading sequences from Sequence Folder..." + "-" * 46)
    elif objType == 'tools':
        ...
        print(textCol + "Loading tools from tools Folder..." + "-" * 53)
    elif objType == 'axes':
        ...
        print(textCol + "Loading axes from axes Folder " + "-" * 57)
    else:
        textCol = Fore.WHITE
        objType = 'invalid'
        objCode = ''
    ...
    for objFile in pcpObjFiles:
        ...
        try:
            ...
            passCompile = 0
            print(Fore.LIGHTRED_EX + '\t\t' + objFile + "\tfailed syntax check" + textCol)
            logging.exception(inst)
        ...
        if passCompile:
            try:
                ...
                # taken, assign it object number 0 so it stays at the top of
                # the list
    ...
    if objType == 'sequence':
        print(textCol + "Finished Loading Sequence Files! " + "-" * 54 + Style.RESET_ALL)
    elif objType == 'tools':
        print(textCol + "Finished Loading Tool Files! " + "-" * 58 + Style.RESET_ALL)
    elif objType == 'axes':
        print(textCol + "Finished Loading Axes Files! " + "-" * 58 + Style.RESET_ALL)
...
def io_pollRecipes(silentMode=False):
    ...
    for name in recipeNames:
        try:
            ...
            newStub = recipeStub(name=recipeekList[0][8:].rstrip(), description=recipeekList[1][15:].rstrip(),
                                 dateCreated=recipeekList[2][16:].rstrip(), fullFilePath=fullpath)
...
def io_loadRecipe(rStub: recipeStub):
    ...
    try:
        ...
        logging.exception(inst)
        __activeRecipe__ = backupActive
        print(Fore.RED + "\tError activating sequence - reverting to previous "
...
def io_saveRecipe(activeStub: recipeStub):
    ...
    try:
        ...
        doSave = True
        if fileExists:
            doSaveInp = io_Prompt(Fore.YELLOW + "\tA recipe with this filename already exists, "
                                                "do you want to overwrite "
                                                "it? (Y/N) If not, try renaming this recipe "
                                                "first: ", validate=True, validResponse=["Y", "N"])
        ...
        if doSave:
            ...
            outstring = "# Name: " + __activeRecipe__.name + "\n# Description: " + __activeRecipe__.description + "\n# Date Created: " + __activeRecipe__.dateCreated + "\n" + __activeRecipe__.writeLogSelf()
...
def io_displayRecipe():
    ...
    outStrings = [Fore.YELLOW + "(P0) Active Recipe Name: " + __activeRecipe__.name,
                  ...
                  Fore.WHITE + "Begin Sequence List " + "-" * 100, Fore.WHITE + "\t|  %5s  | %20s | %25s | %50s |" % (
                      str.center("Index", 5), str.center("Sequence Name", 20), str.center("Sequence Type", 25),
    ...
    if __activeRecipe__.seqList is None:
        ...
        for seq in __activeRecipe__.seqList:
            index = index + 1
            outStrings.append(Fore.WHITE + "\t| (%5s) | %20s | %25s | %50s|" % (
                str.center("S" + str(index), 5), str.center(seq.dictParams.get("name").value, 20),
...
def io_startLog():
    ...
    try:
        ...
        logDir = rootDir / 'Logs'
        now = datetime.now()
        strDate = str(now.year) + str(now.month) + str(now.day) + "_" + str(now.hour) + str(now.minute) + str(
            now.second)
...
def main():
    ...
    while not doQuitProgram:
        try:
            ...
            if menuFlag == 'quit':
                inp = io_Prompt(promptString=("Really quit (Y,q)?"
                                              " or return to main menu? (N): "), validate=True,
                                validResponse=["Y", "N", "q"], caseSensitive=False)
                if inp.lower() == 'n':
                    main()
                else:
            ...
            inp = io_Prompt(promptString="Restart the program? (Y/N): ", validate=True, validResponse=["Y", "N"],
                            caseSensitive=False)
            if inp.lower() == 'y':
                main()
            else:
